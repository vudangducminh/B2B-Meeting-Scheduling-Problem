...
for input_file in input_files:
    ...
    if not solver.solve():
        ...
        max_bound = max_break_count * nBusiness
        l = 0
        r = max_bound 
        while r >= l:
            mid = int(l + (r - l + 1) / 5)
    ...
    print(f"Multiple SAT solving completed in {solve_time - solve_start:.4f} seconds")
